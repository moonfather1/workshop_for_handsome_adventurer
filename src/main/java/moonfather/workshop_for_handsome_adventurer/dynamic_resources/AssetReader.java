...
public abstract class AssetReader
{
    ...
    public static AssetReader getInstance(PackType packType, String namespace)
    {
        if (packType.equals(PackType.SERVER_DATA))
        {
            ...
            {
                //if (ModList.get().isLoaded("dynamic_asset_generator")) { serverReader = new DAGResourceReader(packType, namespace); } else
        ...
        if (packType.equals(PackType.CLIENT_RESOURCES))
        {
            ...
            {
                //if (ModList.get().isLoaded("dynamic_asset_generator")) { clientReader = new DAGResourceReader(packType, namespace); } else
    ...
    protected static class RawResourceReader extends AssetReader
    {
